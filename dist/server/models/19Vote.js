...
exports.Tournament = _mongoose2.default.model('Tournament', TournamentSchema);

exports.Title = _mongoose2.default.model('Title', TitleSchema);

exports.Team = _mongoose2.default.model('Team', TeamSchema);

exports.Clan = _mongoose2.default.model('Clan', ClanSchema);

exports.Match = _mongoose2.default.model('Match', MatchSchema);

exports.User = _mongoose2.default.model('User', UserSchema);

exports.Rank = _mongoose2.default.model('Rank', RankSchema);

exports.Vote = _mongoose2.default.model('Vote', VoteSchema);
